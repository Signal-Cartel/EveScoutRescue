		...
		<div class="panel-group" id="faqAccordion">
			<div class="panel panel-default">
				...
				<div id="question10" class="panel-collapse collapse" style="height: 0px;">
					<div class="panel-body">
						<p>Please head over to our in-game public channel, "Eve-Scout", and ask for a Signal Cartel member to guide you to one of our rescue caches or rescue frigates or to help set up a search and rescue request. If you would like to be more discreet, you can EVEmail <a href="https://gate.eveonline.com/Profile/Thrice%20Hapus">Thrice Hapus</a> to further discuss rescue options.</p>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
			...
			<div class="panel panel-default">
				<div class="panel-heading accordion-toggle question-toggle collapsed" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question4">
					<h4 class="panel-title">
						<a href="#" class="ing">I live in this wormhole. Does a search and rescue present any threat to me?</a>
					</h4>
				</div>
				<div id="question4" class="panel-collapse collapse" style="height: 0px;">
					<div class="panel-body">
						<p>While we respect the inhabitants of every wormhole, it is not always possible to contact them prior to conducting a search in their system. We do not share information about our travels with any third parties. For further inquiries regarding EvE-Scout Rescue's initiatives or policies, please contact <a href="https://gate.eveonline.com/Profile/Thrice%20Hapus">Thrice Hapus</a>.</p>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				...
				<div id="question5" class="panel-collapse collapse" style="height: 0px;">
					<div class="panel-body">
						...
						<p>Within Signal Cartel, each pilot is encouraged to participate in and invent ways to embody all that the Credo envisions. The Search and Rescue program is merely one of the myriad ways our pilots strive to live up to that high calling.</p>
